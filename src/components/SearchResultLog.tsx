              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      {/* Desktop/tablet: render as table for better alignment */}
                      <table className="hidden md:table w-full border-separate" style={{ borderSpacing: 0 }}>
                        <thead>
                          <tr>
                            {[1,2,3,4,5,6,7].map((value) => (
                              <th key={value} className="text-center pb-2 font-normal text-xs" style={{ width: '14.2857%' }}>
                      ...
                      {/* Mobile: 7-column grid with labels and large tap targets */}
