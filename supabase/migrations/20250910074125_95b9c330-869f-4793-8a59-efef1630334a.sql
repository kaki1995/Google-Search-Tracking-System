...
CREATE TABLE public.post_task_survey (
    ...
    q19_topic_familiarity INTEGER CHECK (q19_topic_familiarity >= 1 AND q19_topic_familiarity <= 7),
    
    -- Question 20: Google search satisfaction (Likert 1-7)
    q20_google_satisfaction INTEGER CHECK (q20_google_satisfaction >= 1 AND q20_google_satisfaction <= 7),
    
    -- Question 21: Google search ease (Likert 1-7)
    q21_google_ease INTEGER CHECK (q21_google_ease >= 1 AND q21_google_ease <= 7),
    
    -- Question 22: Google search relevance (Likert 1-7)
    q22_google_relevance INTEGER CHECK (q22_google_relevance >= 1 AND q22_google_relevance <= 7),
    
    -- Question 23: Google search trust (Likert 1-7)
    q23_google_trust INTEGER CHECK (q23_google_trust >= 1 AND q23_google_trust <= 7),
    ...
    q25_tool_effectiveness INTEGER CHECK (q25_tool_effectiveness >= 1 AND q25_tool_effectiveness <= 7),
    
    -- Question 26: Attention check (Likert 1-7)
    q26_attention_check INTEGER CHECK (q26_attention_check >= 1 AND q26_attention_check <= 7),
    
    -- Question 27: First response satisfaction (Likert 1-7)
    q27_first_response_satisfaction INTEGER CHECK (q27_first_response_satisfaction >= 1 AND q27_first_response_satisfaction <= 7),
...
CREATE POLICY "Allow insert for data collection" ON public.post_task_survey FOR INSERT USING (true);
