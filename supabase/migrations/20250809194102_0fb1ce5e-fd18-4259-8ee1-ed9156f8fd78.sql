-- Enhanced SERP Experiment Tracking Schema (Corrected)
-- Migration: 20250809184400_corrected
...
CREATE INDEX IF NOT EXISTS idx_interactions_type_time ON public.interactions(interaction_type, interaction_time);
...
-- Create computed views for analytics (using correct column names)
...
ORDER BY i.query_id, i.interaction_time ASC;
