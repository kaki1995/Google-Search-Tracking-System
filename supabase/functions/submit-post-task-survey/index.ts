...
serve(async (req) => {
  ...
  try {
    ...
    const payload = {
      ...
      q20_google_satisfaction: Number(responses.q20_google_satisfaction ?? 0),
      q21_google_ease: Number(responses.q21_google_ease ?? 0),
      ...
      q26_attention_check: Number(responses.q26_attention_check ?? 0),
      q27_first_response_satisfaction: Number(responses.q27_first_response_satisfaction ?? 0),
      q28_task_duration: String(responses.q28_task_duration ?? ''),
