...
serve(async (req) => {
  ...
  try {
    ...
    const payload = {
      participant_id,
      session_id,
      q19_task_easy: Number(responses.q1_task_easy ?? 0),
      q20_task_quick: Number(responses.q2_task_quick ?? 0),
      q21_task_familiar: Number(responses.q3_task_familiar ?? 0),
      q22_tool_reliable: Number(responses.q4_tool_reliable ?? 0),
      q23_tool_practical: Number(responses.q5_tool_practical ?? 0),
      q24_tool_like: Number(responses.q6_tool_like ?? 0),
      q25_tool_easy_use: Number(responses.q7_tool_easy_use ?? 0),
      q26_tool_clear_interaction: Number(responses.q8_tool_clear_interaction ?? 0),
      q27_tool_control: Number(responses.q9_tool_control ?? 0),
      q28_tool_provides_info: Number(responses.q10_tool_provides_info ?? 0),
      q29_tool_helps_complete: Number(responses.q11_tool_helps_complete ?? 0),
      q30_tool_useful: Number(responses.q12_tool_useful ?? 0),
      q31_tool_too_much_info: Number(responses.q13_tool_too_much_info ?? 0),
      q32_tool_hard_focus: Number(responses.q14_tool_hard_focus ?? 0),
      q33_results_accurate: Number(responses.q15_results_accurate ?? 0),
      q34_results_trustworthy: Number(responses.q16_results_trustworthy ?? 0),
